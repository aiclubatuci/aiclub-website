...
export default function TeamCard({ member }: { member: Member }) {
  return (
    <a
      ...
      className="flex flex-col rounded-lg w-full sm:max-w-64 md:max-w-sm h-52 sm:h-96 border border-[#363636]/40 rounded-lg hover:border-[#363636] active:border-[#363636] transition-colors duration-300 overflow-hidden"
    >
      {/* Profile Image */}
      <div className="flex-[8] relative">
        ...
        {/* Linkedin Logo */}
        <div className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 bg-[#0A66C2] rounded-sm transition-all duration-150 hover:scale-[1.15] active:scale-[1.3]">
          <svg
